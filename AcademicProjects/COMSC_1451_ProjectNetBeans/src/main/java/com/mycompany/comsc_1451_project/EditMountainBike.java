 ...
 * @author Christopher
 */
public class EditMountainBike extends javax.swing.JFrame {

    /**
     * Creates new form EditBasicBike
     */
    public EditMountainBike() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit Mountain Bike Menu-do not leave properties blank-");
        ...
        jLabel8.setText("Flat Proof Tires");

        jLabel9.setText("Full Suspension");
    ...
    private void submitButton1_adBasicBike_addMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButton1_adBasicBike_addMenuActionPerformed
        ...
        InventoryControlGUI.sh_MountainBike_add_EditMenu = Integer.parseInt(sh_input_box_MountainBike_addMenu.getText());
        InventoryControlGUI.fpt_MountainBike_add_EditMenu = Boolean.valueOf(fpt_input_box_MountainBike_addMenu.getText());
        InventoryControlGUI.fs_MountainBike_add_EditMenu = Boolean.valueOf(fs_input_box_MountainBike_addMenu.getText());
        InventoryControlGUI.EditMountainBikeInventory( InventoryControlGUI.myMountainBikeInventory,100,BikeNumber);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditMountainBike.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditMountainBike().setVisible(true);
            }
        });
    }
